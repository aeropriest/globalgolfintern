    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>We've successfully received your expression of interest for the Global Golf Internship.</p>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Best regards,<br>The Global Golf Internship Team</p>
            </div>
            <div class="socials">
            ...
            <div class="footer">
                &copy; ${new Date().getFullYear()} Global Golf Internship & 59club Academy.
            </div>
        </div>
    </body>
    </html>
