...
export default function FileDropzone({ 
  ...
  // Note: For testing, manually upload '~/Downloads/Arian_Gibson_CV.pdf' when testing the form
  // We're not creating a mock file automatically to avoid TypeScript errors
